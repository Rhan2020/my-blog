...
这是个真实的技术悬案，发生在一个普通的开发夜晚...

刚刚为博客添加了暗夜主题切换和标签分类功能，本地测试一切完美。兴奋地推送代码，看着GitHub Actions亮起绿灯✅，打开线上网站准备截图发朋友圈炫耀...
...
Next.js的`.next`目录保留了旧的构建缓存，即使代码已经更新，它仍然坚持使用旧版本。
...
- name: 应用状态检查
  ...
  with:
    ...
    script: |
      ...
      echo "==== HTTPS测试 ===="
      curl -I https://rshan.cc || echo "外部访问存在问题"
```
